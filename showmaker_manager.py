...
from firebase import firebase #library for support the connection for firebase DB
...
class shoeMakerRegister(object):
    ...
    # this function create new user on the DB
    ...
    # this function create the manager User on the DB under table 'Admin'
